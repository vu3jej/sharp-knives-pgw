...
--
-- ALTER TABLE books
--   ADD CONSTRAINT at_least_one_edition_for_book FOREIGN KEY (initial_edition_id) REFERENCES editions (id);
--
-- ALTER TABLE books
--   ALTER CONSTRAINT at_least_one_edition_for_book DEFERRABLE INITIALLY DEFERRED;

-- Relax the "at least one" criterion
-- ALTER TABLE books DROP COLUMN initial_edition_id;
...
ALTER TABLE authors_books
  ADD CONSTRAINT authors_books_belongs_to_book FOREIGN KEY (book_id) REFERENCES books(id);

ALTER TABLE authors_books
  ADD CONSTRAINT authors_books_belongs_to_author FOREIGN KEY (author_id) REFERENCES authors(id);
...
ALTER TABLE users
  ADD CONSTRAINT login_size_limits CHECK (
      length(login) >= 3 AND ((admin AND length(login) <= 100) OR
